...
const Customer = () => {
  ...
  const images = [
    ...
    'https://lifeofchai.in/Images/gallery/girl-group-customer-img-min.jpg',
    'https://lifeofchai.in/Images/gallery/family-customer2.jpg',
    'https://lifeofchai.in/Images/gallery/IMG_8236-min.jpg',
